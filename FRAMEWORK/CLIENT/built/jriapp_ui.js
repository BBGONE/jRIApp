...
define("jriapp_ui/dialog", ["require", "exports", "jriapp_core/template", "jriapp_core/lang", "jriapp_core/object", "jriapp_utils/utils", "jriapp_core/bootstrap", "jriapp_core/mvvm"], function (require, exports, template_1, langMOD, object_1, utils_1, bootstrap_1, mvvm_1) {
    "use strict";
    var utils = utils_1.Utils, checks = utils.check, strUtils = utils.str, coreUtils = utils.core;
    var $ = utils.dom.$, doc = utils.dom.document, ERROR = utils.err, boot = bootstrap_1.bootstrap;
...
define("jriapp_ui/dynacontent", ["require", "exports", "jriapp_core/template", "jriapp_utils/utils", "jriapp_core/bootstrap", "jriapp_elview/elview"], function (require, exports, template_2, utils_2, bootstrap_2, elview_1) {
    "use strict";
    var utils = utils_2.Utils, checks = utils.check, strUtils = utils.str, coreUtils = utils.core;
    var PROP_NAME = {
        template: "template",
...
define("jriapp_ui/datagrid/columns/base", ["require", "exports", "jriapp_core/const", "jriapp_core/template", "jriapp_core/object", "jriapp_utils/utils", "jriapp_elview/elview", "jriapp_core/bootstrap", "jriapp_ui/datagrid/const"], function (require, exports, const_1, template_3, object_3, utils_3, elview_2, bootstrap_3, const_2) {
    ...
    var BaseColumn = (function (_super) {
        ...
        BaseColumn.prototype.destroy = function () {
            ...
            if (!!this._options.tip) {
                elview_2.fn_addToolTip($(this._col), null);
            }
            if (!!this._template) {
                this._template.destroy();
                this._template = null;
        ...
        Object.defineProperty(BaseColumn.prototype, "isSelected", {
            ...
            set: function (v) {
                if (!!this._col && this._isSelected !== v) {
                    this._isSelected = v;
                    utils.dom.setClass([this._col], const_2.css.columnSelected, !this._isSelected);
                }
            },
            enumerable: true,
            configurable: true
...
define("jriapp_ui/datagrid/columns/expander", ["require", "exports", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/columns/base"], function (require, exports, utils_4, const_3, base_1) {
    "use strict";
    var utils = utils_4.Utils, dom = utils.dom, $ = dom.$;
    var ExpanderColumn = (function (_super) {
        ...
        function ExpanderColumn(grid, options) {
            ...
            dom.addClass([this.col], const_3.css.rowExpander);
        }
...
define("jriapp_ui/datagrid/cells/expander", ["require", "exports", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/base"], function (require, exports, utils_5, const_4, base_2) {
    "use strict";
    var utils = utils_5.Utils, dom = utils.dom, $ = dom.$;
    var ExpanderCell = (function (_super) {
        ...
        function ExpanderCell(options) {
            ...
            dom.addClass([this.td], const_4.css.rowCollapsed);
            dom.addClass([this.td], const_4.css.rowExpander);
        }
        ...
        ExpanderCell.prototype.toggleImage = function () {
            if (this.row.isExpanded) {
                dom.removeClass([this.td], const_4.css.rowCollapsed);
                dom.addClass([this.td], const_4.css.rowExpanded);
            }
            else {
                dom.removeClass([this.td], const_4.css.rowExpanded);
                dom.addClass([this.td], const_4.css.rowCollapsed);
            }
        };
...
define("jriapp_ui/datagrid/columns/data", ["require", "exports", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/columns/base"], function (require, exports, utils_6, const_5, base_3) {
    "use strict";
    var utils = utils_6.Utils, dom = utils.dom, $ = dom.$;
    var DataColumn = (function (_super) {
        __extends(DataColumn, _super);
        function DataColumn(grid, options) {
            _super.call(this, grid, options);
            this._objCache = {};
            var colClass = const_5.css.dataColumn;
...
define("jriapp_ui/datagrid/cells/data", ["require", "exports", "jriapp_core/lang", "jriapp_content/factory", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/base"], function (require, exports, lang_1, factory_1, utils_7, const_6, base_4) {
    "use strict";
    var utils = utils_7.Utils, dom = utils.dom, $ = dom.$;
    var DataCell = (function (_super) {
        ...
        function DataCell(options) {
            ...
            dom.addClass([this.td], const_6.css.dataCell);
            this._initContent();
        }
...
define("jriapp_ui/datagrid/columns/actions", ["require", "exports", "jriapp_core/const", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/columns/base"], function (require, exports, const_7, utils_8, const_8, base_5) {
    "use strict";
    var utils = utils_8.Utils, dom = utils.dom, $ = dom.$;
    var ActionsColumn = (function (_super) {
        ...
        function ActionsColumn(grid, options) {
            ...
            dom.addClass([this.col], const_8.css.rowActions);
...
define("jriapp_ui/datagrid/cells/actions", ["require", "exports", "jriapp_core/const", "jriapp_core/lang", "jriapp_core/shared", "jriapp_elview/elview", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/base"], function (require, exports, const_9, lang_2, shared_1, elview_3, utils_9, const_10, base_6) {
    "use strict";
    var utils = utils_9.Utils, dom = utils.dom, $ = dom.$, strUtils = utils.str, checks = utils.check;
    ...
    var ActionsCell = (function (_super) {
        ...
        function ActionsCell(options) {
            ...
            dom.addClass([this.td], [const_10.css.rowActions, const_10.css.nobr].join(" "));
        ...
        ActionsCell.prototype.destroy = function () {
            if (this._isDestroyed)
                return;
            this._isDestroyCalled = true;
            var $td = $(this.td), $imgs = $td.find(const_10.actionsSelector);
        ...
        ActionsCell.prototype._setupImages = function ($images) {
            ...
            $images.each(function (index, img) {
                ...
                $img.attr(const_9.DATA_ATTR.DATA_EVENT_SCOPE, self.column.uniqueID);
            });
        };
...
define("jriapp_ui/datagrid/columns/rowselector", ["require", "exports", "jriapp_core/const", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/columns/base"], function (require, exports, const_11, utils_10, const_12, base_7) {
    "use strict";
    var utils = utils_10.Utils, dom = utils.dom, $ = dom.$, doc = dom.document, checks = utils.check;
    var RowSelectorColumn = (function (_super) {
        ...
        function RowSelectorColumn(grid, options) {
            ...
            _super.call(this, grid, options);
            var self = this;
            this._event_chk_scope = ["input[", const_11.DATA_ATTR.DATA_EVENT_SCOPE, '="', this.uniqueID, '"]'].join("");
            dom.addClass([this.col], const_12.css.rowSelector);
            var label = doc.createElement("label");
            var chk = doc.createElement("input");
            chk.type = "checkbox";
            chk.checked = false;
            chk.className = const_12.css.rowSelector;
            label.className = const_12.css.rowSelector;
        ...
        Object.defineProperty(RowSelectorColumn.prototype, "checked", {
            ...
            set: function (v) {
                ...
                if (!!chk) {
                    if (bv !== chk.checked) {
                        chk.checked = bv;
                        this.raisePropertyChanged(const_12.PROP_NAME.checked);
                    }
                }
            },
            enumerable: true,
...
define("jriapp_ui/datagrid/cells/rowselector", ["require", "exports", "jriapp_core/const", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/base"], function (require, exports, const_13, utils_11, const_14, base_8) {
    "use strict";
    var utils = utils_11.Utils, dom = utils.dom, $ = dom.$, doc = dom.document, checks = utils.check;
    var RowSelectorCell = (function (_super) {
        __extends(RowSelectorCell, _super);
        function RowSelectorCell(options) {
            _super.call(this, options);
            dom.addClass([this.td], const_14.css.rowSelector);
            var label = doc.createElement("label");
            var chk = doc.createElement("input");
            chk.type = "checkbox";
            chk.checked = false;
            chk.className = const_14.css.rowSelector;
            label.className = const_14.css.rowSelector;
...
define("jriapp_ui/datagrid/rows/row", ["require", "exports", "jriapp_core/object", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/expander", "jriapp_ui/datagrid/cells/data", "jriapp_ui/datagrid/cells/actions", "jriapp_ui/datagrid/cells/rowselector", "jriapp_ui/datagrid/columns/expander", "jriapp_ui/datagrid/columns/actions", "jriapp_ui/datagrid/columns/rowselector"], function (require, exports, object_4, utils_12, const_15, expander_1, data_1, actions_1, rowselector_1, expander_2, actions_2, rowselector_2) {
    "use strict";
    var utils = utils_12.Utils, dom = utils.dom, $ = dom.$, doc = dom.document;
...
define("jriapp_ui/datagrid/cells/base", ["require", "exports", "jriapp_core/const", "jriapp_core/object", "jriapp_utils/dblclick", "jriapp_utils/utils"], function (require, exports, const_16, object_5, dblclick_1, utils_13) {
    "use strict";
    var utils = utils_13.Utils, dom = utils.dom, $ = dom.$;
    var BaseCell = (function (_super) {
        ...
        function BaseCell(options) {
            ...
            this._td.setAttribute(const_16.DATA_ATTR.DATA_EVENT_SCOPE, this._column.uniqueID);
...
define("jriapp_ui/datagrid/rows/details", ["require", "exports", "jriapp_core/object", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/details"], function (require, exports, object_6, utils_14, const_17, details_1) {
    "use strict";
    var utils = utils_14.Utils, checks = utils.check, strUtils = utils.str, coreUtils = utils.core, arrHelper = utils.arr;
...
define("jriapp_ui/datagrid/cells/details", ["require", "exports", "jriapp_core/template", "jriapp_core/object"], function (require, exports, template_4, object_7) {
    "use strict";
...
define("jriapp_ui/datagrid/rows/fillspace", ["require", "exports", "jriapp_core/object", "jriapp_utils/utils", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/cells/fillspace"], function (require, exports, object_8, utils_15, const_18, fillspace_1) {
    "use strict";
    var utils = utils_15.Utils, $ = utils.dom.$;
...
define("jriapp_ui/datagrid/cells/fillspace", ["require", "exports", "jriapp_core/object", "jriapp_utils/utils", "jriapp_ui/datagrid/const"], function (require, exports, object_9, utils_16, const_19) {
    "use strict";
    var utils = utils_16.Utils, dom = utils.dom;
...
define("jriapp_ui/datagrid/datagrid", ["require", "exports", "jriapp_core/const", "jriapp_core/lang", "jriapp_core/object", "jriapp_utils/debounce", "jriapp_utils/utils", "jriapp_core/bootstrap", "jriapp_core/parser", "jriapp_elview/elview", "jriapp_content/int", "jriapp_ui/dialog", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/animation", "jriapp_ui/datagrid/rows/row", "jriapp_ui/datagrid/rows/details", "jriapp_ui/datagrid/rows/fillspace", "jriapp_ui/datagrid/columns/expander", "jriapp_ui/datagrid/columns/data", "jriapp_ui/datagrid/columns/actions", "jriapp_ui/datagrid/columns/rowselector", "jriapp_ui/datagrid/rows/row", "jriapp_ui/datagrid/columns/base", "jriapp_ui/datagrid/const", "jriapp_ui/datagrid/animation"], function (require, exports, const_20, lang_3, object_10, debounce_1, utils_17, bootstrap_4, parser_1, elview_4, int_1, dialog_1, const_21, animation_1, row_1, details_2, fillspace_2, expander_3, data_2, actions_3, rowselector_3, row_2, base_9, const_22, animation_2) {
    ...
    function findDataGrid(gridName) {
        ...
        for (var i = 0; i < keys.length; i += 1) {
            var grid = _created_grids[keys[i]];
            if (grid.$table.attr(const_20.DATA_ATTR.DATA_NAME) === gridName)
                return grid;
        }
        return null;
    }
    ...
    var DataGrid = (function (_super) {
        ...
        DataGrid.prototype._parseColumnAttr = function (column_attr, content_attr) {
            var defaultOp = {
                "type": const_21.COLUMN_TYPE.DATA,
                title: null,
                sortable: false,
                sortMemberName: null,
                content: null
        ...
        DataGrid.prototype._onDSCurrentChanged = function (prevCurrent, newCurrent) {
            if (prevCurrent !== newCurrent) {
                ...
                if (!!oldRow) {
                    oldRow.raisePropertyChanged(const_21.PROP_NAME.isCurrent);
                    dom.removeClass([oldRow.tr], const_21.css.rowHighlight);
                }
                if (!!newRow) {
                    newRow.raisePropertyChanged(const_21.PROP_NAME.isCurrent);
                    dom.addClass([newRow.tr], const_21.css.rowHighlight);
                }
            }
        };
        ...
        DataGrid.prototype._onItemEdit = function (item, isBegin, isCanceled) {
            ...
            this.raisePropertyChanged(const_21.PROP_NAME.editingRow);
        };
        ...
        DataGrid.prototype._wrapTable = function () {
            ...
            dom.addClass([wrapper], const_21.css.wrapDiv);
            dom.addClass([container], const_21.css.container);
            dom.addClass([header], const_21.css.headerDiv);
            if (options.wrapCss) {
        ...
        DataGrid.prototype._createColumns = function () {
            ...
            for (var i = 0; i < cnt; i += 1) {
                var th = headCells[i];
                var attr = this._parseColumnAttr(th.getAttribute(const_20.DATA_ATTR.DATA_COLUMN), th.getAttribute(const_20.DATA_ATTR.DATA_CONTENT));
        ...
        Object.defineProperty(DataGrid.prototype, "dataSource", {
            ...
            set: function (v) {
                ...
                if (!!this.dataSource)
                    this._bindDS();
                this.raisePropertyChanged(const_21.PROP_NAME.dataSource);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var DataGridElView = (function (_super) {
        ...
        DataGridElView.prototype._bindGridEvents = function () {
            ...
            this._grid.addOnDestroyed(function (s, args) {
                var self = this;
                self._grid = null;
                self.raisePropertyChanged(const_21.PROP_NAME.grid);
            }, this.uniqueID, this);
        };
        ...
        Object.defineProperty(DataGridElView.prototype, "stateProvider", {
            ...
            set: function (v) {
                if (v !== this._stateProvider) {
                    ...
                    this.raisePropertyChanged(const_21.PROP_NAME.stateProvider);
                }
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(DataGridElView.prototype, "animation", {
            ...
            set: function (v) {
                ...
                if (this.animation !== v) {
                    ...
                    this.raisePropertyChanged(const_21.PROP_NAME.animation);
                }
            },
            enumerable: true,
            configurable: true
...
define("jriapp_ui/pager", ["require", "exports", "jriapp_core/lang", "jriapp_core/object", "jriapp_utils/debounce", "jriapp_utils/utils", "jriapp_elview/elview", "jriapp"], function (require, exports, lang_4, object_11, debounce_2, utils_18, elview_5, jriapp_1) {
    "use strict";
    var utils = utils_18.Utils, dom = utils.dom, $ = dom.$, doc = utils.dom.document, checks = utils.check, strUtils = utils.str, coreUtils = utils.core, ERROR = utils.err, boot = jriapp_1.bootstrap;
...
define("jriapp_ui/stackpanel", ["require", "exports", "jriapp_core/const", "jriapp_core/template", "jriapp_core/lang", "jriapp_core/object", "jriapp_utils/utils", "jriapp_elview/elview", "jriapp"], function (require, exports, const_23, template_5, lang_6, object_13, utils_20, elview_7, jriapp_2) {
    "use strict";
    var utils = utils_20.Utils, dom = utils.dom, $ = dom.$, doc = dom.document, checks = utils.check, strUtils = utils.str, coreUtils = utils.core, boot = jriapp_2.bootstrap;
    var css = {
    ...
    var StackPanel = (function (_super) {
        ...
        StackPanel.prototype._appendItem = function (item) {
            ...
            item_el.setAttribute(const_23.DATA_ATTR.DATA_EVENT_SCOPE, this.uniqueID);
...
define("jriapp_ui/tabs", ["require", "exports", "jriapp_utils/utils", "jriapp_core/bootstrap", "jriapp_elview/elview"], function (require, exports, utils_21, bootstrap_6, elview_8) {
    "use strict";
    var utils = utils_21.Utils, coreUtils = utils.core;
    var PROP_NAME = {
        tabIndex: "tabIndex",
    ...
    bootstrap_6.bootstrap.registerElView("tabs", TabsElView);
});
define("jriapp_ui", ["require", "exports", "jriapp_core/bootstrap", "jriapp_ui/dialog", "jriapp_ui/dynacontent", "jriapp_ui/datagrid/datagrid", "jriapp_ui/pager", "jriapp_ui/listbox", "jriapp_ui/stackpanel", "jriapp_ui/tabs"], function (require, exports, bootstrap_7, dialog_2, dynacontent_1, datagrid_1, pager_1, listbox_1, stackpanel_1, tabs_1) {
    "use strict";
    function __export(m) {
