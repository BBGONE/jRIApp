                ...
                if (serviceTypeInfo.IsGenericTypeDefinition)
                {
                        ...
                        !implementationTypeInfo.IsGenericTypeDefinition)
                    {
                        throw new ArgumentException(
                            string.Format("OpenGenericService {0} RequiresOpenGenericImplementation",
                               descriptor.ServiceType), nameof(descriptors));
                    }
                    ...
                    {
                        throw new ArgumentException(
                           string.Format("Type {0} can not be activated {1}",
