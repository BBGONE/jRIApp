...
/*
	Generated from: /RIAppDemoServiceEF/code?lang=ts on 2016-12-22 at 11:50
...
export interface CustomerJSON extends dbMOD.IEntityItem {
    readonly CustomerID: number;
    Data: string;
    readonly rowguid: string;
...
export class CustomerJSONDb extends dbMOD.DbSet<CustomerJSON, DbContext>
{
    constructor(dbContext: DbContext) {
        var opts: dbMOD.IDbSetConstuctorOptions = {
            dbContext: dbContext,
        ...
        opts.dbSetInfo.fieldInfos = ([{ "fieldName": "CustomerID", "isPrimaryKey": 1, "dataType": 3, "isNullable": false, "isReadOnly": true, "isAutoGenerated": true, "isNeedOriginal": true, "maxLength": 4, "dateConversion": 0, "allowClientDefault": false, "range": "", "regex": "", "fieldType": 0, "dependentOn": "", "nested": null }, { "fieldName": "Data", "isPrimaryKey": 0, "dataType": 1, "isNullable": false, "isReadOnly": false, "isAutoGenerated": false, "isNeedOriginal": true, "maxLength": -1, "dateConversion": 0, "allowClientDefault": false, "range": "", "regex": "", "fieldType": 0, "dependentOn": "", "nested": null }, { "fieldName": "rowguid", "isPrimaryKey": 0, "dataType": 9, "isNullable": false, "isReadOnly": true, "isAutoGenerated": true, "isNeedOriginal": true, "maxLength": 16, "dateConversion": 0, "allowClientDefault": false, "range": "", "regex": "", "fieldType": 4, "dependentOn": "", "nested": null }, { "fieldName": "Customer", "isPrimaryKey": 0, "dataType": 0, "isNullable": true, "isReadOnly": false, "isAutoGenerated": false, "isNeedOriginal": true, "maxLength": -1, "dateConversion": 0, "allowClientDefault": false, "range": "", "regex": "", "fieldType": 2, "dependentOn": "", "nested": null }]);
        super(opts);
        this._createEntityType();
    }
    private _createEntityType(): void {
        //class expression
        this._entityType = class extends RIAPP.CollectionItem<dbMOD.EntityAspect<CustomerJSON, DbContext>> implements CustomerJSON {

            constructor(aspect: dbMOD.EntityAspect<CustomerJSON, DbContext>) {
                super(aspect);
    ...
    createReadCustomerJSONQuery(): dbMOD.DataQuery<CustomerJSON> {
